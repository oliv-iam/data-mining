...
public class SONMRMulti {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job1 = Job.getInstance(conf, "SONMR Multi First Round");
        ...
        Job job2 = Job.getInstance(conf, "SONMR Multi Second Round");
        job2.setJarByClass(SONMRMulti.class);

        job2.setMapperClass(MapperFour.class);
        ...
        System.err.println("Job: SONMR Multi");
